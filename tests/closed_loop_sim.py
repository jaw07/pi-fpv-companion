...
def imx500_servo(width: int = 720, height: int = 576, **overrides) -> ServoConfig:
    base = dict(
        ...
        dive_pitch_fold=0.6, vfov_deg=52.3, dive_terminal_lock_frac=0.5,
        dive_roll_gain=0.05, dive_roll_damp=0.45, yaw_roll_blend_px=160.0,  # roll off (yaw-only; see imx500.yaml)
